---
description: "Searches and references official TON blockchain documentation, standards (TEPs), and SDK guides via the TON Docs MCP server. Use this skill when answering questions about TON architecture, smart contracts, FunC, Tact, Tolk, TL-B schemas, validators, sharding, message routing, wallet contracts, jetton standard (TEP-74), NFT standard (TEP-62), TON addresses, BOC encoding, or any TON protocol details.\n"
license: "MIT"
metadata: {"author":"ton-tech","version":"0.2.0"}
---
# TON Documentation
