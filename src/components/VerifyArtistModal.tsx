          ...
          {step === 1 && (
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4">
              <div className="space-y-2">
                <h3 className="text-sm font-bold text-white uppercase tracking-tight">Artist Information</h3>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="text-[10px] font-bold text-white/40 uppercase tracking-widest">Social Protocols</div>
                  <div className="space-y-3">
                    <div className="flex items-center gap-3 p-1 bg-white/5 rounded-2xl border border-white/5 focus-within:border-blue-500/30 transition-all">
                      <div className="w-10 h-10 rounded-xl bg-black/40 flex items-center justify-center text-white/40">
