...
const NFTQuickViewModal: React.FC<NFTQuickViewModalProps> = ({ nft, isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-2 sm:p-2 animate-in fade-in duration-300">
      ...
      <div className="relative w-full max-w-2xl glass bg-background rounded-[4px] overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300 flex flex-col md:flex-row max-h-[80vh] md:max-h-[600px] min-h-[400px]">
                ...
                <div className="mb-2">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {nft.traits.slice(0, 4).map((trait) => (
                      <div key={trait.trait_type} className="bg-muted/50 rounded-[4px] p-2">
              ...
              <div className="mt-auto pt-2 space-y-2">
                ...
                <div className="flex gap-2">
                  <button 
                    ...
                    className="flex-1 py-2 bg-white/5 hover:bg-white/10 text-foreground rounded-[4px] font-bold text-[10px] uppercase tracking-widest transition-all shadow-lg flex items-center justify-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
                  >
                  ...
                  {nft.owner === MOCK_USER.walletAddress && !nft.listingType && (
                    <button 
                      ...
                      className="flex-1 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-[4px] font-bold text-[10px] uppercase tracking-widest transition-all shadow-lg shadow-blue-600/20 flex items-center justify-center gap-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
                    >
                      Sell NFT
                    </button>
                  )}
