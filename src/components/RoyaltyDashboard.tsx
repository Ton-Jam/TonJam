    ...
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="glass border border-blue-500/10 p-8 rounded-[10px] bg-foreground/[0.02] relative overflow-hidden group">
          ...
          <h3 className="text-[9px] font-bold text-muted-foreground/50 uppercase tracking-[0.4em] mb-6">Streaming Revenue</h3>
          <div className="flex items-baseline gap-2">
            <span className="text-3xl font-bold text-foreground tracking-tighter">{earnings.streaming}</span>
        ...
        <div className="glass border border-blue-500/10 p-8 rounded-[10px] bg-foreground/[0.02] relative overflow-hidden group">
          ...
          <h3 className="text-[9px] font-bold text-muted-foreground/50 uppercase tracking-[0.4em] mb-6">NFT Royalties</h3>
          <div className="flex items-baseline gap-2">
            <span className="text-3xl font-bold text-foreground tracking-tighter">{earnings.nftSales}</span>
        ...
        <div className="glass border border-blue-500/10 p-8 rounded-[10px] bg-blue-600/5 relative overflow-hidden group">
          ...
          <div className="flex items-baseline gap-2">
            <span className="text-3xl font-bold text-foreground tracking-tighter">{earnings.total}</span>
            <span className="text-[10px] font-bold text-blue-400 uppercase">TON</span>
          </div>
          <button className="w-full mt-6 py-3 bg-blue-600 text-foreground rounded-[10px] text-[8px] font-bold uppercase tracking-widest hover:bg-blue-500 transition-all shadow-lg shadow-blue-600/20">Withdraw to Wallet</button>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="space-y-6">
            <div>
              ...
              <p className="text-[8px] text-muted-foreground/50 mt-3 leading-relaxed">Percentage of platform-wide streaming pool allocated to your broadcasted frequencies.</p>
            </div>
            ...
            <div>
              ...
              <p className="text-[8px] text-muted-foreground/50 mt-3 leading-relaxed">Defined share from every secondary market sale of your minted NFT assets.</p>
            </div>
          </div>
          ...
          <div className="bg-blue-600/5 p-8 rounded-[10px]">
            ...
            <p className="text-[8px] text-foreground/30 mt-6 leading-relaxed italic">"Royalties are distributed automatically via the TonJam Forge protocol upon every successful transaction or stream event."</p>
          </div>
        </div>
      </div>
    </div>
