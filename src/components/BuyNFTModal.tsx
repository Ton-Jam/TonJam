      ...
      <div className="relative glass w-full max-w-sm rounded-[10px] border border-border shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
        ...
        <div className="p-8 relative z-10">
          ...
          <button
            ...
            className="w-full py-4 bg-blue-600 hover:bg-blue-500 rounded-[10px] text-[10px] font-bold uppercase tracking-widest text-foreground shadow-xl shadow-blue-600/20 active:scale-95 transition-all flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed">
