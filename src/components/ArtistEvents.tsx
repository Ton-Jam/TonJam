  ...
  return (
    <section className="bg-card p-6 rounded-[10px] border border-blue-500/20">
      ...
      <div className="space-y-4">
        {events.map((event) => (
          <div key={event.id} className="group relative overflow-hidden rounded-[10px] bg-muted/30 hover:bg-muted/50 transition-all border border-transparent hover:border-blue-500/30">
            ...
            <div className="relative z-10 flex items-center justify-between p-4">
              <div className="flex items-center gap-4">
                <div className="text-center bg-background/80 backdrop-blur-md p-2 rounded-[8px] min-w-[60px] border border-white/5">
              ...
              {event.ticketUrl && (
                <a 
                  ...
                  className="px-4 py-2 bg-blue-600/10 hover:bg-blue-600 text-blue-500 hover:text-white rounded-[8px] text-[10px] font-bold uppercase tracking-widest transition-all border border-blue-500/20 flex items-center gap-2"
                >
