...
import { ResponsiveContainer, BarChart, Bar, XAxis, YAxis, Tooltip, Legend, PieChart, Pie, Cell, LineChart, Line, CartesianGrid, ScatterChart, Scatter, ZAxis } from 'recharts';
  ...
  return (
    <div className="p-6 bg-background space-y-8 animate-in fade-in duration-500">
          ...
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={revenueTrendData}>
                ...
                <Line type="monotone" dataKey="revenue" data={revenueTrendData.filter(d => !d.projected)} stroke="#3b82f6" strokeWidth={2} dot={false} />
                {revenueTimeFrame === 'Daily' && (
                  <Line type="monotone" dataKey="revenue" data={revenueTrendData.filter(d => d.projected)} stroke="#3b82f6" strokeWidth={2} strokeDasharray="5 5" dot={false} />
                )}
              </LineChart>
            </ResponsiveContainer>
          </div>
      ...
      <div className="bg-card p-6 rounded-3xl border border-border">
          ...
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={streamingActivityData}>
                <CartesianGrid strokeDasharray="4 4" stroke="#333" />
      ...
      <div className="bg-card p-6 rounded-3xl border border-border">
          ...
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={weeklyStreamsData}>
                <CartesianGrid strokeDasharray="4 4" stroke="#333" />
                <XAxis dataKey="day" stroke="#666" fontSize={10} />
                <YAxis stroke="#666" fontSize={10} />
                <Tooltip contentStyle={{ backgroundColor: '#111', border: 'none' }} />
      ...
      <div className="bg-card p-6 rounded-3xl border border-border">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="h-48">
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                      <Pie data={splits} dataKey="value" nameKey="name" cx="50%" cy="50%" outerRadius={60} fill="#8884d8">
      ...
      <div className="bg-card p-6 rounded-3xl border border-border">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-sm font-bold uppercase tracking-widest">Royalty Audit Log</h3>
