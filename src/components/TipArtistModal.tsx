      ...
      >
        <div className="p-5">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h2 className="text-xl font-black text-gray-900 uppercase tracking-tighter">Support</h2>
              <p className="text-[9px] font-black text-blue-600 uppercase tracking-widest mt-0.5">Transmission Protocol</p>
            </div>
          ...
          <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-2xl border border-gray-100 mb-4">
            ...
            />
            <div>
              <p className="text-sm font-black text-gray-900 uppercase">{artist.name}</p>
              <p className="text-[9px] text-gray-400 uppercase tracking-widest">{artist.location || 'Distributed'}</p>
            </div>
          </div>

          <div className="space-y-4">
            <div>
              <label className="text-[9px] font-black text-gray-400 uppercase tracking-[0.2em] mb-2 block">Amount (TON)</label>
            ...
            <div className="relative">
              <input 
                ...
                className="w-full bg-gray-50 border border-gray-200 rounded-2xl px-4 py-3 text-gray-900 font-black text-lg placeholder:text-gray-300 focus:outline-none focus:border-blue-500/50 transition-all"
                placeholder="0.00"
              />
              <div className="absolute right-4 top-1/2 -translate-y-1/2 flex items-center gap-1.5">
                ...
                <span className="text-[10px] font-black text-gray-400 uppercase">TON</span>
              </div>
            </div>

            <div className="p-3 bg-blue-50 border border-blue-100 rounded-xl flex gap-2">
              <Info className="w-3.5 h-3.5 text-blue-500 shrink-0" />
              <p className="text-[9px] text-blue-900/60 leading-tight">
                90% of your tip goes to {artist.name}. 10% supports TonJam infrastructure.
              </p>
            </div>
            ...
            <button 
              ...
              className="w-full py-3 bg-blue-600 hover:bg-blue-500 disabled:opacity-50 disabled:cursor-not-allowed rounded-full text-white font-black text-[10px] uppercase tracking-[0.2em] transition-all flex items-center justify-center gap-2 shadow-lg active:scale-95"
            >
              {isProcessing ? (
        ...
        <div className="bg-gray-50 p-4 flex items-center justify-center gap-2 border-t border-gray-100">
          ...
          <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Secured by TON Blockchain</span>
        </div>
      </motion.div>
    </div>
  );
