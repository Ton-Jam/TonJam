...
import { ChevronRight, Verified, Users, Play } from 'lucide-react';
...
const FeaturedArtists: React.FC = () => {
  const { artists, allTracks, playTrack } = useAudio();
        ...
        {featuredArtists.map((artist) => {
          ...
          return (
            <motion.div
              ...
              className="w-[280px] shrink-0 bg-[#101A3B]/60 rounded-3xl p-5 border border-white/5 hover:border-blue-500/30 transition-all group relative overflow-hidden cursor-pointer"
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-5 relative z-10">
                <Avatar className="w-14 h-14 border-2 border-white/10 group-hover:border-blue-500/50 transition-colors shadow-xl">
                ...
                <div className="min-w-0">
                  ...
                  <div className="flex items-center gap-2 text-[10px] text-zinc-500 font-bold uppercase tracking-widest mt-1">
                    ...
                    {(artist.followers || 0).toLocaleString()} <span className="text-[8px] opacity-60 lowercase">followers</span>
                  </div>
                </div>
              </div>
