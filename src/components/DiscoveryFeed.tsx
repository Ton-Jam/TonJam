  ...
  return (
    <div className="space-y-2 animate-in fade-in duration-700">
        ...
        <div className="flex items-center justify-between mb-2">
          ...
          <div className="flex items-center gap-2">
            <button 
              ...
              className="flex items-center gap-2 px-2 py-2 bg-blue-600 hover:bg-blue-500 text-foreground rounded-full text-[10px] font-bold uppercase tracking-widest transition-all active:scale-95 shadow-[0_0_15px_rgba(37,99,235,0.3)]"
            >
      ...
      <section>
        <div className="flex items-center justify-between mb-2">
          ...
          <button 
            ...
            className="text-[10px] font-bold text-amber-500 hover:text-amber-400 transition-colors uppercase tracking-widest flex items-center gap-2"
          >
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-2">
        <div className="glass border border-neutral-500/20 bg-foreground/[0.02] p-2 rounded-[10px] relative overflow-hidden group hover:border-neutral-500/40 transition-all">
