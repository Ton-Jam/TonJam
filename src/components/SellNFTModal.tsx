...
const SellNFTModal: React.FC<SellNFTModalProps> = ({ nft, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-2 animate-in fade-in duration-300">
      ...
      <div className="relative w-full max-sm bg-black/90 backdrop-blur-md rounded-[4px] overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300 border border-white/10">
        ...
        <div className="p-3 flex items-center justify-between relative z-10 border-b border-white/5">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-[4px] bg-blue-600/20 flex items-center justify-center text-blue-400">
          ...
          <button onClick={onClose} className="p-1.5 text-white/40 hover:text-white transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-blue-500 rounded-[4px] bg-white/5" aria-label="Close Sell NFT Modal">
        ...
        <form onSubmit={handleSubmit} className="p-3 space-y-3 relative z-10">
          <div className="flex gap-2">
            <button 
              ...
              className={`flex-1 p-2.5 rounded-[4px] transition-all text-center space-y-1 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-blue-500 border border-transparent ${listingType === 'fixed' ? 'bg-blue-600/20 text-blue-400 border-blue-500/30' : 'bg-white/5 text-white/40 hover:bg-white/10'}`}
            ...
            <button 
              ...
              className={`flex-1 p-2.5 rounded-[4px] transition-all text-center space-y-1 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-amber-500 border border-transparent ${listingType === 'auction' ? 'bg-amber-500/20 text-amber-400 border-amber-500/30' : 'bg-white/5 text-white/40 hover:bg-white/10'}`}
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-white/5 border border-white/5 rounded-[4px] py-1.5 pl-9 pr-3 text-white font-bold outline-none focus-visible:ring-1 focus-visible:ring-blue-500 transition-all text-xs"
                  placeholder="0.00"
                  required
              ...
              <div className="space-y-2 animate-in slide-in-from-top-2 duration-300">
                ...
                <div className="relative group">
                  <input 
                    ...
                    className="w-full bg-white/5 border border-white/5 rounded-[4px] py-2 px-3 text-white font-bold outline-none focus-visible:ring-1 focus-visible:ring-amber-500 transition-all text-[10px] mb-2 pr-10"
                ...
                <div className="flex gap-1.5 mb-2">
                  {['1', '3', '7', '14'].map((d) => (
                    <button
                      ...
                      className={`flex-1 py-1.5 rounded-[4px] text-[8px] font-bold transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-amber-500 ${duration === d ? 'bg-amber-500 text-black' : 'bg-white/5 text-white/40 hover:bg-white/10'}`}
          ...
          <div className="p-2 bg-blue-500/5 border border-blue-500/10 rounded-[4px] flex gap-2">
          ...
          <div className="flex gap-2">
            <button 
              type="button"
              onClick={onClose}
              className="flex-1 py-1.5 rounded-[4px] font-bold text-[8px] uppercase tracking-[0.15em] text-white/40 bg-white/5 hover:bg-white/10 transition-all active:scale-95 border border-white/5"
            >
              Cancel
            </button>
            <button 
              ...
              className={`flex-[1.5] py-1.5 rounded-[4px] font-bold text-[8px] uppercase tracking-[0.15em] text-white transition-all active:scale-95 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-blue-500
