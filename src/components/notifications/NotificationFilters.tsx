        ...
        return (
          <motion.button
            ...
            className={`
              ...
              cursor-pointer shrink-0 outline-none border
              ${isActive 
                ? 'bg-[#0088CC] text-white border-[#c0c0c0]/40 shadow-[0_0_16px_rgba(0,136,204,0.45)]'
                : 'bg-zinc-900/90 text-zinc-400 hover:text-white hover:bg-[#0088CC]/20 border-[#c0c0c0]/25'
              }
            `}
          >
