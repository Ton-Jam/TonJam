            ...
            >
              ...
              <div className="space-y-2 sm:space-y-4 pt-1 sm:pt-2 md:pt-4 w-full max-w-2xl flex flex-col justify-center">
                ...
                <div className="flex items-center justify-between px-2 sm:px-4 max-w-md mx-auto w-full pt-1">
                  ...
                  <button
                    onClick={prevTrack}
                    className="text-white hover:text-white active:scale-90 transition-all h-12 w-12 sm:h-20 sm:w-20 md:h-22 md:w-22 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center cursor-pointer shrink-0 border-0 outline-none focus:outline-none"
                  >
