        ...
        <div className="mx-auto w-full max-md relative z-10">
          ...
          <DrawerHeader className="pb-6 pt-4">
            <div className="flex items-center gap-5">
              <div className="relative w-16 h-16 rounded-full overflow-hidden shadow-2xl flex-shrink-0">
                <img 
            ...
            <div className="grid grid-cols-1 gap-1">
              ...
              {destructiveOptions.map((option, index) => (
                <motion.button
                  ...
                  className="w-full flex items-center gap-4 p-3 rounded-[12px] hover:bg-white/5 active:bg-white/10 active:scale-[0.98] transition-all text-left group focus-visible:outline-none"
                >
                  <div className="w-10 h-10 rounded-[8px] bg-white/5 flex items-center justify-center group-hover:bg-red-500/10 group-active:scale-90 transition-all">
                    <option.icon className={`h-4 w-4 ${option.iconColor} transition-transform group-hover:scale-110`} />
                  </div>
                  <div className="flex-1">
                    <span className={`text-[10px] font-bold uppercase tracking-[0.3em] ${option.color}`}>
