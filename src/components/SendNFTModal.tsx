  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <motion.div 
        ...
        className="relative w-full max-w-md bg-[#0A0A0A] border border-white/10 rounded-[20px] overflow-hidden shadow-2xl"
      >
        {/* Header */}
          ...
          <AnimatePresence mode="wait">
            {step === 'input' && (
              <motion.div 
                ...
                className="space-y-6"
              >
                <div className="flex items-center gap-4 p-4 bg-white/5 rounded-[12px] border border-white/5">
                  ...
                  <div>
                    ...
                    <p className="text-[10px] font-bold text-white/40 uppercase tracking-widest mt-1">{nft.edition}</p>
                  </div>
                </div>
            ...
            {step === 'confirm' && (
              ...
              >
                <div className="space-y-2">
                  <h3 className="text-xl font-bold text-white uppercase tracking-tighter">Confirm Transfer</h3>
                  <p className="text-[10px] font-bold text-white/40 uppercase tracking-widest">You are sending {nft.title} to:</p>
                </div>

                <div className="p-6 bg-white/5 border border-white/10 rounded-[16px] break-all">
            ...
            {step === 'sending' && (
              ...
              >
                ...
                <div className="text-center space-y-2">
                  <h3 className="text-sm font-bold text-white uppercase tracking-[0.3em]">Broadcasting Signal</h3>
                  <p className="text-[9px] font-bold text-white/20 uppercase tracking-widest">Awaiting TON network confirmation...</p>
                </div>
              </motion.div>
            )}
            ...
            {step === 'success' && (
              ...
              >
                ...
                <div className="space-y-2">
                  <h3 className="text-sm font-bold text-white uppercase tracking-[0.3em]">Transfer Complete</h3>
