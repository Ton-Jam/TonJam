  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-[8rem] items-start gap-3 rounded-lg border border-border/50 bg-background px-3 py-3 text-xs shadow-xl",
          className
        )}
      >
                        ...
                        <div
                          className={cn(
                            "shrink-0 rounded-2 border-[--color-border] bg-[--color-bg]",
                            {
                              ...
                              "w-1": indicator === "line",
                              "w-0 border bg-transparent":
                                indicator === "dashed",
                              "my-3": nestLabel && indicator === "dashed",
                            }
                          )}
                          style={
                            {
