  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          "group/day relative aspect-square h-full w-full select-none p-2 text-center [&:first-child[data-selected=true]_button]:rounded-l-md [&:last-child[data-selected=true]_button]:rounded-r-md",
