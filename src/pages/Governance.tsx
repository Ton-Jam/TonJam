          ...
          <div className="flex items-center gap-1">
             ...
             {['all', 'active', 'passed', 'rejected', 'treasury'].map((tab) => (
               <button
                 ...
                 className={`px-4 py-2 rounded-full text-[10px] font-bold uppercase tracking-wider transition-all ${activeTab === tab ? 'bg-primary text-primary-foreground shadow-lg shadow-primary/20' : 'text-muted-foreground hover:bg-muted/50'}`}
               >
                 {tab}
               </button>
             ))}
