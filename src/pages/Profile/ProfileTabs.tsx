      ...
      {tabs.map((tab) => {
        ...
        return (
          <button
            ...
            className={`relative px-5 py-2.5 rounded-full text-xs font-bold uppercase tracking-wider transition-all duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#0088CC] cursor-pointer whitespace-nowrap shrink-0 z-10 border ${
              isActive
                ? 'border-[#c0c0c0]/40'
