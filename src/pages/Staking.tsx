      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <div className="glass p-4 rounded-3xl border border-border/50 space-y-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-foreground uppercase tracking-tighter">Stake Tokens</h3>
              <p className="text-[10px] font-bold text-muted-foreground/50 uppercase tracking-widest">Deposit JAM to start earning</p>
            </div>
          </div>
        ...
        <div className="glass p-4 rounded-3xl border border-border/50 space-y-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold text-foreground uppercase tracking-tighter">Unstake Tokens</h3>
              <p className="text-[10px] font-bold text-muted-foreground/50 uppercase tracking-widest">Withdraw your JAM from protocol</p>
            </div>
          </div>
