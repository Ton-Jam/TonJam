    ...
    <div className="min-h-screen bg-background text-foreground p-8 md:p-16 max-w-4xl mx-auto">
      ...
      >
        <header className="space-y-4">
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter uppercase text-foreground">About Us</h1>
        ...
        <section className="space-y-6">
          <h2 className="text-2xl font-bold uppercase tracking-widest text-blue-500">Our Mission</h2>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            ...
            <div key={idx} className="p-6 rounded-2xl bg-muted/50 border border-border/50 flex items-start gap-4">
        ...
        <section className="space-y-6">
          <h2 className="text-2xl font-bold uppercase tracking-widest text-blue-500">The Creators</h2>
          <p className="text-lg text-muted-foreground/90 leading-relaxed">
