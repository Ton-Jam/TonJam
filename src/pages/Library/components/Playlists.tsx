...
export const Playlists: React.FC<PlaylistsProps> = ({
  ...
  return (
    <div className="space-y-4">
      ...
      <LayoutGroup id="playlists-layout-group">
        <motion.div 
          layout
        ...
        >
          ...
          {playlists.map((playlist) => (
            <motion.div
              ...
              className={
                layout === 'grid'
                  ? "relative bg-white/[0.02] dark:bg-white/[0.02] bg-black/[0.02] border border-black/5 dark:border-white/5 p-3 rounded-[10px] flex flex-col justify-between group h-full"
              ...
              {layout === 'grid' ? (
                <>
                  ...
                  <div className="space-y-1">
                    <motion.h4 
                      layoutId={`playlist-title-${playlist.id}`}
                      className="text-xs font-extrabold text-foreground leading-snug line-clamp-1"
                    >
                      {playlist.title}
                    </motion.h4>
