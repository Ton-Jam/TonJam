        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              <h4 
                onClick={handleProfileClick}
                className="font-black text-sm text-white uppercase tracking-tight truncate hover:text-blue-400 transition-colors cursor-pointer italic"
              >
                {post.userName}
              </h4>
              {!isMe && (
            ...
            <span className="text-[9px] text-white/30 uppercase tracking-[0.3em] font-black italic">
              {post.timestamp}
            </span>
          </div>
        </div>
        
        <p className="text-white/80 leading-relaxed mb-6 text-[13px] italic font-medium border-l-2 border-white/5 pl-5">
          {post.content}
        </p>
          ...
          <div className="mt-8 pt-8 border-t border-white/5 animate-in slide-in-from-top-4 duration-500">
            <form onSubmit={handleAddComment} className="flex gap-4 mb-8">
              ...
              <div className="flex-1 relative">
                <input 
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl py-2 px-4 text-xs outline-none focus:border-blue-500/50 transition-all text-white italic"
                />
                <button 
                  type="submit"
            ...
            <div className="space-y-6">
              ...
              {post.comments > 0 && comments.length === 0 && (
                <p className="text-center py-4 text-[9px] font-black text-white/10 uppercase tracking-[0.4em] italic">
