      ...
      <div className="relative glass w-full max-w-sm rounded-[2.5rem] border border-amber-500/20 shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
        <div className="p-8">
          <header className="flex justify-between items-center mb-8">
            <div>
              <h2 className="text-xl font-black italic uppercase tracking-tighter text-white">Neural Auction</h2>
              <p className="text-[7px] font-black text-amber-500 uppercase tracking-[0.4em] italic mt-1">Live Bidding Relay</p>
            </div>
          ...
          <div className="mb-8">
            <div className="flex justify-between text-[8px] font-black text-white/30 uppercase tracking-widest mb-3 italic px-2">
              <span>Current Highest</span>
              <span>Min Next Bid</span>
            </div>
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-white/5 border border-white/10 p-4 rounded-xl text-center">
                <p className="text-lg font-black text-white italic">{currentBid} <span className="text-[8px] text-blue-500">TON</span></p>
              </div>
              <div className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-xl text-center">
                <p className="text-lg font-black text-amber-500 italic">{minBid} <span className="text-[8px]">TON</span></p>
              </div>
            </div>
          </div>

          <div className="space-y-4 mb-8">
            <label className="text-[8px] font-black text-white/30 uppercase tracking-widest px-2 italic">Your Bid Amount</label>
