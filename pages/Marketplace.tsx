    ...
    <div className="animate-in fade-in duration-700 pb-40 w-full bg-black min-h-screen">
      ...
      <div className="sticky top-0 z-[45] bg-black/95 backdrop-blur-xl border-b border-white/5 py-1.5 px-6 flex items-center justify-between overflow-hidden whitespace-nowrap">
        <div className="flex items-center gap-2 mr-8 flex-shrink-0">
          ...
          <span className="text-[7px] font-black text-white/30 uppercase tracking-[0.3em] italic">NODE_RELAY: ONLINE</span>
        </div>
        <div className="flex gap-16 animate-[marquee_35s_linear_infinite]">
          {[
            ...
            <div key={i} className="flex items-center gap-2">
              ...
              <span className="text-[9px] font-black text-white italic tracking-tighter">{stat.val}</span>
        ...
        <section className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-[8px] font-black text-white/40 uppercase tracking-[0.4em] italic">Live Relay: Top Bids</h3>
            </div>
          ...
          >
                ...
                <div className="relative aspect-[1080/480] bg-[#050505] rounded-xl overflow-hidden border border-white/5 hover:border-amber-500/30 transition-all shadow-2xl">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black via-black/10 to-transparent flex flex-col justify-end p-5 md:p-8">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <span className="text-[9px] font-black text-white/60 uppercase tracking-widest italic">{nft.offers?.length || 0} ACTIVE BIDS</span>
                    </div>

                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                      <div className="flex-1">
                        <h2 className="text-2xl md:text-4xl font-black italic uppercase tracking-tighter text-white mb-1 leading-none drop-shadow-2xl">{nft.title}</h2>
                        <div className="flex items-center gap-3 text-blue-500">
                          <div className="flex items-center gap-2">
                            ...
                            <p className="text-[9px] font-black uppercase tracking-widest italic">@{nft.creator}</p>
                          </div>
                          <div className="h-3 w-px bg-white/10"></div>
                          <div className="flex flex-col">
                            <span className="text-[6px] text-white/40 uppercase font-black tracking-widest">Est. Market Cap</span>
                            <span className="text-[9px] text-white font-black italic tracking-tighter">{calculateMarketCap(nft)} TON</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center gap-6 glass p-4 rounded-xl border-white/10 min-w-[240px]">
                        <div className="flex-1">
                          <p className="text-[7px] font-black text-white/20 uppercase tracking-[0.3em] mb-0.5 italic">Highest Bid</p>
                          <div className="flex items-center gap-1.5">
                            <img src={TON_LOGO} className="w-4 h-4" alt="" />
                            <span className="text-xl font-black text-white italic tracking-tighter">{nft.price} TON</span>
                          </div>
                        </div>
            ...
            >
              ...
              <span className="text-[10px] font-black text-white/20 uppercase tracking-[0.5em] italic group-hover:text-white transition-colors">Forge New Protocol</span>
            </div>
          </div>
        </section>
        ...
        <section className="mb-12 animate-in fade-in slide-in-from-bottom duration-1000 delay-200">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-black italic tracking-tighter uppercase text-white leading-none">Trending Protocols</h2>
                <p className="text-[7px] font-black text-white/20 uppercase tracking-[0.4em] italic mt-1">High-bandwidth market signals detected</p>
              </div>
            </div>
            <button 
                ...
                <div className="relative glass rounded-xl p-4 border border-white/5 hover:border-blue-500/30 transition-all bg-[#0a0a0a]/40 overflow-hidden">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      <h3 className="text-xs font-black text-white uppercase italic tracking-tighter truncate flex-1">{nft.title}</h3>
                    ...
                    <div className="flex items-center justify-between pt-2 border-t border-white/5">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[8px] font-black text-white/40 uppercase tracking-tighter italic">@{nft.creator}</span>
                      </div>
                      <div className="flex items-center gap-1">
                        <i className="fas fa-chart-line text-[7px] text-green-500"></i>
                        <span className="text-[8px] font-black text-white italic">{nft.offers?.length || 0} Bids</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="flex items-center gap-3 w-full xl:w-auto">
              <div className="relative flex-1 xl:w-[280px]">
                ...
                <input 
                  ...
                  className="w-full bg-white/5 border border-white/10 py-2 pl-10 pr-4 rounded-full text-[11px] outline-none focus:border-blue-500/40 transition-all placeholder:text-white/10 text-white italic"
                />
              </div>
              <div className="flex items-center bg-white/5 border border-white/10 rounded-full px-4 py-2">
                <span className="text-[8px] font-black text-white/20 uppercase tracking-widest mr-3 italic">Sort:</span>
                <select 
                    value={sortBy}
                    onChange={(e) => setSortBy(e.target.value)}
                    className="bg-transparent text-white text-[9px] font-black uppercase outline-none cursor-pointer pr-1 italic"
                >
        ...
        <section>
          {filteredNfts.length > 0 ? (
            ...
            <div className="py-32 flex flex-col items-center justify-center glass rounded-3xl border-dashed border-white/5 text-center bg-[#050505]/50">
              ...
              <h3 className="text-xl font-black uppercase italic tracking-tighter text-white/20">Frequency Mismatch</h3>
              <p className="text-[9px] font-black text-white/10 uppercase tracking-[0.4em] italic mt-2 px-8">No matching signals detected in the market relay.</p>
              <button 
          ...
          <div className="glass p-8 md:p-10 rounded-2xl border border-blue-500/10 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden bg-gradient-to-br from-blue-500/[0.03] to-transparent">
             ...
             <div className="text-center md:text-left">
                <div className="flex items-center justify-center md:justify-start gap-2 mb-1.5">
                  <div className="w-1 h-1 bg-blue-500 rounded-full animate-pulse"></div>
                  <span className="text-[8px] font-black text-blue-400 uppercase tracking-[0.5em] italic">Genesis Whitelist</span>
                </div>
                <h4 className="text-xl md:text-3xl font-black italic uppercase tracking-tighter text-white leading-none">THE NEURAL DROP</h4>
                <p className="text-[8px] font-black text-white/20 uppercase tracking-[0.4em] italic mt-1.5">Subscribe to the relay for exclusive mint protocols.</p>
             </div>
             <div className="flex gap-2 w-full md:w-auto">
                <input type="email" placeholder="NEURAL_ID@MAIL.COM" className="flex-1 md:w-64 bg-black/50 border border-white/10 rounded-lg px-4 py-3 text-[9px] font-black outline-none focus:border-blue-500 italic text-white" />
